...
public class Route1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spds = (Spinner) findViewById(R.id.spinnerdst);
        spsr = (Spinner) findViewById(R.id.spinner_src);
    ...
    class BackgroundTask extends AsyncTask<String, Void, String> {
        ...
        public void onPreExecute() {
            json_url = "http://bustracker.ga/json_get_data2.php";
        }
        ...
        protected void onPostExecute(String result) {
            ...
            if(!result.equals("Wrong Route....Bus available on route5"))
            {
