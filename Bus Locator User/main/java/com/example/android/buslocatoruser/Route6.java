...
public class Route6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_route6);
            ...
            spds = (Spinner) findViewById(R.id.spinnerdst6);
            spsr = (Spinner) findViewById(R.id.spinner_src6);
    ...
    class BackgroundTask extends AsyncTask<String, Void, String> {
        ...
        public void onPreExecute() {
            json_url = "http://bustracker.ga/json_get_data7.php";
        }
        ...
        protected void onPostExecute(String result) {
            ...
            if(!result.equals("Wrong Route....Bus available on route2"))
            {
                Toast.makeText(getApplicationContext(), result, Toast.LENGTH_SHORT).show();
                TextView tv=(TextView)findViewById(R.id.fare6);
                tv.setText(result);
