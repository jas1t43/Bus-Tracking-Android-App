...
public class Route2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spds = (Spinner) findViewById(R.id.spinnerdst2);
        spsr = (Spinner) findViewById(R.id.spinner_src2);
        adapters = ArrayAdapter.createFromResource(this, R.array.strsrc2, android.R.layout.simple_spinner_item);
        adapters.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        adapterd = ArrayAdapter.createFromResource(this, R.array.strdes2, android.R.layout.simple_spinner_item);
    ...
    class BackgroundTask extends AsyncTask<String, Void, String> {
        ...
        public void onPreExecute() {
            json_url = "http://bustracker.ga/json_get_data3.php";
        }
        ...
        protected void onPostExecute(String result) {
            ...
            if(!result.equals("Wrong Route....Bus available on route6"))
            {
                Toast.makeText(getApplicationContext(), result, Toast.LENGTH_SHORT).show();
                TextView tv=(TextView)findViewById(R.id.fare2);
                tv.setText(result);
