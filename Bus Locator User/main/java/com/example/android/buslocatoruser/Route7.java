...
public class Route7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spds = (Spinner) findViewById(R.id.spinnerdst7);
        spsr = (Spinner) findViewById(R.id.spinner_src7);
    ...
    class BackgroundTask extends AsyncTask<String, Void, String> {
        ...
        public void onPreExecute() {
            json_url = "http://bustracker.ga/json_get_data8.php";
        }
        ...
        protected void onPostExecute(String result) {
            ...
            if(!result.equals("Wrong Route....Bus available on route3"))
            {
                Toast.makeText(getApplicationContext(), result, Toast.LENGTH_SHORT).show();
                TextView tv=(TextView)findViewById(R.id.fare7);
                tv.setText(result);
