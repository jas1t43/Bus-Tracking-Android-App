...
public class Route3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spds = (Spinner) findViewById(R.id.spinnerdst3);
        spsr = (Spinner) findViewById(R.id.spinner_src3);
        adapters = ArrayAdapter.createFromResource(this, R.array.strsrc3, android.R.layout.simple_spinner_item);
        adapters.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        adapterd = ArrayAdapter.createFromResource(this, R.array.strdes3, android.R.layout.simple_spinner_item);
    ...
    class BackgroundTask extends AsyncTask<String, Void, String> {
        ...
        public void onPreExecute() {
            json_url = "http://bustracker.ga/json_get_data4.php";
        }
        ...
        protected void onPostExecute(String result) {
            ...
            if(!result.equals("Wrong Route....Bus available on route7"))
            {
                Toast.makeText(getApplicationContext(), result, Toast.LENGTH_SHORT).show();
                TextView tv=(TextView)findViewById(R.id.fare3);
                tv.setText(result);
